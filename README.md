...
> Las figuras referenciadas como `figuras/*.png` se exportan de las celdas del notebook indicadas en cada sección. Este archivo puede renombrarse a `README.md` para que sea la portada del repositorio.
